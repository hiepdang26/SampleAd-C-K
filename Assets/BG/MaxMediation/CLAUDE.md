...
## Hard rules
- This is a separate git repository. Commits here belong to the MaxMediation repo.
- This is the AppLovin MAX SDK integration boundary — mirrors `AdmobMediation` and
